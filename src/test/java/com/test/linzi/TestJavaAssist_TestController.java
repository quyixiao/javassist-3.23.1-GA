...
import javassist.libs.Factory;
import javassist.libs.LocalvariablesNamesEnhancer;
import lombok.extern.slf4j.Slf4j;

import java.io.ByteArrayInputStream;
import java.util.*;
import javassist.libs.F.T2;
@Slf4j
public class TestJavaAssist_TestController {
    public static void main(String[] args) throws Exception {
        ...
        for (CtMethod method : ctClass.getDeclaredMethods()) {
            ...
            method.insertBefore("javassist.libs.LocalvariablesNamesEnhancer.LocalVariablesNamesTracer.enter();");
            method.insertAfter("javassist.libs.LocalvariablesNamesEnhancer.LocalVariablesNamesTracer.exit();", true);

        }

        //保存生成的字节码
        ctClass.writeFile("/Users/quyixiao/github/javassist-3.23.1-GA/temp");
    }
